    ...
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-1 p-1.5">
        ...
        {/* The Output pane used to sit here — print() lines and tracebacks, in a
            box about five lines tall. It has moved out of this window and is to
            get one of its own; the runner still records everything (scriptLog,
            capped and streamed exactly as before) and the bottom status bar
            still shows the newest line, so nothing about what a script reports
            has changed — only where it is read. */}
